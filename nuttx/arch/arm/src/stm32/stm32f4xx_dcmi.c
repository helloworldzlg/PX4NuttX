...
uint32_t DCMI_GetRegVal(uint16_t offset)
{
    uint32_t regVal = 0;
...
uint32_t DMA_GetRegVal(uint16_t offset)
{
    uint32_t regVal = 0;
    ...
    {
        case 0:
            regVal = DMA2_REG->LISR;
            break;
        case 1:
            regVal = DMA2_REG->HISR;
            break;
        case 2:
            regVal = DMA2_Stream1->CR;
            break;
        case 3:
            regVal = DMA2_Stream1->NDTR;
            break;
        case 4:
            regVal = DMA2_Stream1->PAR;
            break;
        case 5:
            regVal = DMA2_Stream1->M0AR;
            break;
        case 6:
            regVal = DMA2_Stream1->M1AR;
            break;
        case 7:
            regVal = DMA2_Stream1->FCR;
            break;
    }
    return regVal;
}
